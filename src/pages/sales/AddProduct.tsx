...
const AddProduct = () => {
  ...
  const onSubmit = async (data: ProductFormData) => {
    ...
    try {
      const payload = {
        ...
        total_quantity: data.total_quantity ? Number(data.total_quantity) : undefined,
  ...
  return (
    <div>
      <Navbar title="Add Product" subtitle="Create a new product record" />
      <div className="xui-py-1">
        ...
        <p className="xui-font-sz-[16px] xui-opacity-4">Fill in the product details below. Fields marked with * are required.</p>
