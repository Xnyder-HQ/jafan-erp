                ...
                <div className="xui-p-1">
                  {stats.total_role_acls_via_role.length > 0 ? (
                    <Chart
                      ...
                      options={{
                        labels: stats.total_role_acls_via_role.map((item) => item.Role.name),
                ...
                <div className="xui-p-1">
                  {stats.total_role_acls_via_module.length > 0 ? (
                    <Chart
                      ...
                      options={{
                        labels: stats.total_role_acls_via_module.map((item) => item.Module.name),
                        colors: ['#3a86ff', '#f59e0b', '#ef4444', '#06d6a0', '#8338ec', '#4361ee', '#fca311', '#f72585'],
                        legend: { position: 'bottom', fontSize: '12px' },
                        dataLabels: { enabled: true, formatter: (val: number) => `${val.toFixed(0)}%` },
                        plotOptions: { pie: { donut: { size: '55%' } } },
                      }}
                ...
                <div className="xui-p-1">
                  {stats.total_role_acls_via_sub_module.length > 0 ? (
                    <Chart
                      ...
                      options={{
                        xaxis: {
                          categories: stats.total_role_acls_via_sub_module.map((item) => item.SubModule.name),
